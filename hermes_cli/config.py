...
_EXTRA_ENV_KEYS = frozenset({
    ...
    "SUPERAGI_API_KEY", "SUPERAGI_API_BASE_URL", "SUPERAGI_BOT_USER_ID",
    "SUPERAGI_WORKSPACE_ID", "SUPERAGI_MQTT_URL", "SUPERAGI_MQTT_PASSWORD",
...
OPTIONAL_ENV_VARS = {
    ...
    # ── SuperAGI ──
    "SUPERAGI_API_KEY": {
        "description": "SuperAGI API key (X-API-KEY header for REST API)",
        "prompt": "SuperAGI API key",
        "url": None,
        "password": True,
        "category": "messaging",
    },
    "SUPERAGI_API_BASE_URL": {
        "description": "SuperAGI REST API base URL (e.g. https://api.superagi.com)",
        "prompt": "SuperAGI API base URL",
        "url": None,
        "password": False,
        "category": "messaging",
    },
    "SUPERAGI_BOT_USER_ID": {
        "description": "Numeric bot user ID on the SuperAGI platform",
        "prompt": "SuperAGI bot user ID",
        "url": None,
        "password": False,
        "category": "messaging",
    },
    "SUPERAGI_WORKSPACE_ID": {
        "description": "Numeric workspace ID on the SuperAGI platform",
        "prompt": "SuperAGI workspace ID",
        "url": None,
        "password": False,
        "category": "messaging",
    },
    "SUPERAGI_MQTT_URL": {
        "description": "MQTT broker WebSocket URL (e.g. ws://emqx.superagi.com:8083/mqtt)",
        "prompt": "SuperAGI MQTT URL",
        "url": None,
        "password": False,
        "category": "messaging",
    },
    "SUPERAGI_MQTT_USERNAME": {
        "description": "MQTT broker username (default: supersales)",
        "prompt": "SuperAGI MQTT username",
        "url": None,
        "password": False,
        "category": "messaging",
    },
    "SUPERAGI_MQTT_PASSWORD": {
        "description": "MQTT broker password",
        "prompt": "SuperAGI MQTT password",
        "url": None,
        "password": True,
        "category": "messaging",
    },
    "SUPERAGI_ALLOWED_USERS": {
        "description": "Comma-separated SuperAGI user IDs allowed to use the bot",
        "prompt": "Allowed SuperAGI user IDs (comma-separated)",
        "url": None,
        "password": False,
        "category": "messaging",
    },
