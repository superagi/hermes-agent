...
_PLATFORMS = [
    ...
    },
    {
        ...
        "label": "SuperAGI",
        "emoji": "🤖",
        "token_var": "SUPERAGI_API_KEY",
        "setup_instructions": [
            "1. Get your API key from the SuperAGI platform",
            "2. Note your Bot User ID and Workspace ID from the admin panel",
            "3. Get the MQTT broker URL and credentials from your platform config",
            "4. Set SUPERAGI_ALLOW_ALL_USERS=true or restrict with SUPERAGI_ALLOWED_USERS",
        ],
        "vars": [
            {"name": "SUPERAGI_API_KEY", "prompt": "API key (X-API-KEY header)", "password": True,
             "help": "Your SuperAGI API key for REST API authentication."},
            {"name": "SUPERAGI_API_BASE_URL", "prompt": "API base URL (e.g. https://api.superagi.com)", "password": False,
             "help": "Base URL of the SuperAGI REST API."},
            {"name": "SUPERAGI_BOT_USER_ID", "prompt": "Bot user ID (numeric)", "password": False,
             "help": "The numeric user ID assigned to your bot."},
            {"name": "SUPERAGI_WORKSPACE_ID", "prompt": "Workspace ID (numeric)", "password": False,
             "help": "The numeric workspace ID the bot belongs to."},
            {"name": "SUPERAGI_MQTT_URL", "prompt": "MQTT broker URL (e.g. ws://emqx.superagi.com:8083/mqtt)", "password": False,
             "help": "WebSocket URL for the MQTT broker."},
            {"name": "SUPERAGI_MQTT_USERNAME", "prompt": "MQTT username (default: supersales)", "password": False,
             "help": "Username for MQTT authentication."},
            {"name": "SUPERAGI_MQTT_PASSWORD", "prompt": "MQTT password", "password": True,
             "help": "Password for MQTT authentication."},
            {"name": "SUPERAGI_ALLOWED_USERS", "prompt": "Allowed user IDs (comma-separated, or empty)", "password": False,
             "is_allowlist": True,
             "help": "Restrict which SuperAGI users can interact with the bot."},
            {"name": "SUPERAGI_HOME_CHANNEL", "prompt": "Home group ID (optional, for cron/notifications)", "password": False,
             "help": "Default group_id for cron job delivery and notifications."},
        ],
    },
    {
        "key": "bluebubbles",
